...
#undef skinSetting
	...
	settings["FakeWalk"]["Enabled"] = Settings::FakeWalk::enabled;

	settings["BackTrack"]["Enabled"] = Settings::Aimbot::BackTrack;
	settings["BackTrack"]["Amount"] = Settings::Aimbot::BackTrackAmount;
	settings["BackTrack"]["Key"] = Util::GetButtonName(Settings::Aimbot::BackTrackKey);
...
void Settings::LoadConfig(std::string path)
{
	...
	Settings::Aimbot::weapons = {{ ItemDefinitionIndex::INVALID,{ false, false, false, Bone::BONE_HEAD, ButtonCode_t::MOUSE_MIDDLE, false, false, 1.0f, SmoothType::SLOW_END, false, 0.0f, false, 0.0f, true, 180.0f, false, 25.0f, false, false, 2.0f, 2.0f, false, false, false, false, false, false, false, false, 10.0f, false, false, false,false } },};
	...
	GetVal(settings["FakeWalk"]["Enabled"], &Settings::FakeWalk::enabled);

	GetVal(settings["BackTrack"]["Enabled"], &Settings::Aimbot::BackTrack);
	GetVal(settings["BackTrack"]["Amount"], &Settings::Aimbot::BackTrackAmount);
	GetButtonCode(settings["BackTrack"]["Key"], &Settings::Aimbot::BackTrackKey);
