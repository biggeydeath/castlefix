...
{
static DWORD dwTemp = *(DWORD*)((GetModuleHandleA("client_panorama.dll") + 0x2EC61BC));
...
void Menu()
{
	...
	if (renderer.IsActive())
	{
		...
		static bool shit;
		ImGui::Begin("pasta", &shit, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_ShowBorders);
		{
