...
public:
	...
	short* GetItemDefinitionIndexx()
	{
		return (short*)((uintptr_t)this + offsets.DT_BaseAttributableItem.m_iItemDefinitionIndex);
	}
	short* GetItemDefinitionIndex2() {
	
		return reinterpret_cast<short*>(uintptr_t(this) + offsets.DT_BaseAttributableItem.m_iItemDefinitionIndex);
	}
	int* GetItemIDHigh()
	{
...
public:
	...
	{
		return *(float*)((uintptr_t)this + 0x010C);//
	}

	float GetSpread()
	{
		return *(float*)((uintptr_t)this + 0x0184);  // shit all for u 0x0134
	}
...
public:
	...
	float GetSpread()
	{
		...
		return getvfunc<oGetSpread>(this, 436)(this);
	}

	void UpdateAccuracyPenalty()
	{
		typedef void(__thiscall*oUpdateAccuracyPenalty)(void*);
		return getvfunc<oUpdateAccuracyPenalty>(this, 468)(this);
	}
};
